...
-- Command     : write_vhdl -force -mode funcsim -rename_top tb_clk_wiz_0 -prefix
--               tb_clk_wiz_0_ tb_clk_wiz_0_sim_netlist.vhdl
-- Design      : tb_clk_wiz_0
...
entity tb_clk_wiz_0_tb_clk_wiz_0_clk_wiz is
  port (
...
end tb_clk_wiz_0_tb_clk_wiz_0_clk_wiz;

architecture STRUCTURE of tb_clk_wiz_0_tb_clk_wiz_0_clk_wiz is
  signal clk_in1_tb_clk_wiz_0 : STD_LOGIC;
  signal clk_out1_tb_clk_wiz_0 : STD_LOGIC;
...
entity tb_clk_wiz_0 is
  ...
  attribute NotValidForBitStream of tb_clk_wiz_0 : entity is true;
end tb_clk_wiz_0;

architecture STRUCTURE of tb_clk_wiz_0 is
begin
inst: entity work.tb_clk_wiz_0_tb_clk_wiz_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,

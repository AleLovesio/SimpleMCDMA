...
//               e:/Files/Test_benches/MCDMA_TB/MCDMA_TB.gen/sources_1/bd/tb/ip/tb_SimpleTxMCDMA_0_0/tb_SimpleTxMCDMA_0_0_stub.v
...
module tb_SimpleTxMCDMA_0_0(s_axi_s_axi_ctrl_AWADDR, 
  ...
  m_axi_mem_RVALID, m_axi_mem_RREADY, TX_stream_TVALID, TX_stream_TREADY, TX_stream_TDATA, 
  TX_stream_TDEST, TX_stream_TKEEP, TX_stream_TSTRB, TX_stream_TLAST)
/* synthesis syn_black_box black_box_pad_pin="s_axi_s_axi_ctrl_AWADDR[5:0],s_axi_s_axi_ctrl_AWVALID,s_axi_s_axi_ctrl_AWREADY,s_axi_s_axi_ctrl_WDATA[31:0],s_axi_s_axi_ctrl_WSTRB[3:0],s_axi_s_axi_ctrl_WVALID,s_axi_s_axi_ctrl_WREADY,s_axi_s_axi_ctrl_BRESP[1:0],s_axi_s_axi_ctrl_BVALID,s_axi_s_axi_ctrl_BREADY,s_axi_s_axi_ctrl_ARADDR[5:0],s_axi_s_axi_ctrl_ARVALID,s_axi_s_axi_ctrl_ARREADY,s_axi_s_axi_ctrl_RDATA[31:0],s_axi_s_axi_ctrl_RRESP[1:0],s_axi_s_axi_ctrl_RVALID,s_axi_s_axi_ctrl_RREADY,ap_clk,ap_rst_n,interrupt,m_axi_mem_AWID[0:0],m_axi_mem_AWADDR[31:0],m_axi_mem_AWLEN[7:0],m_axi_mem_AWSIZE[2:0],m_axi_mem_AWBURST[1:0],m_axi_mem_AWLOCK[1:0],m_axi_mem_AWREGION[3:0],m_axi_mem_AWCACHE[3:0],m_axi_mem_AWPROT[2:0],m_axi_mem_AWQOS[3:0],m_axi_mem_AWVALID,m_axi_mem_AWREADY,m_axi_mem_WID[0:0],m_axi_mem_WDATA[31:0],m_axi_mem_WSTRB[3:0],m_axi_mem_WLAST,m_axi_mem_WVALID,m_axi_mem_WREADY,m_axi_mem_BID[0:0],m_axi_mem_BRESP[1:0],m_axi_mem_BVALID,m_axi_mem_BREADY,m_axi_mem_ARID[0:0],m_axi_mem_ARADDR[31:0],m_axi_mem_ARLEN[7:0],m_axi_mem_ARSIZE[2:0],m_axi_mem_ARBURST[1:0],m_axi_mem_ARLOCK[1:0],m_axi_mem_ARREGION[3:0],m_axi_mem_ARCACHE[3:0],m_axi_mem_ARPROT[2:0],m_axi_mem_ARQOS[3:0],m_axi_mem_ARVALID,m_axi_mem_ARREADY,m_axi_mem_RID[0:0],m_axi_mem_RDATA[31:0],m_axi_mem_RRESP[1:0],m_axi_mem_RLAST,m_axi_mem_RVALID,m_axi_mem_RREADY,TX_stream_TVALID,TX_stream_TREADY,TX_stream_TDATA[31:0],TX_stream_TDEST[1:0],TX_stream_TKEEP[3:0],TX_stream_TSTRB[3:0],TX_stream_TLAST[0:0]" */;

...
#(parameter
    ...
    output wire [0:0]                    channel_descr_done_q0,
...
assign channel_descr_done_q0                      = int_channel_descr_done_q0 >> (int_channel_descr_done_shift0 * 8);
...
assign int_channel_descr_done_we1                 = int_channel_descr_done_write & w_hs;
assign int_channel_descr_done_be1                 = int_channel_descr_done_we1 ? WSTRB : 'b0;
assign int_channel_descr_done_d1                  = WDATA;
// channel_descr_error
...
// int_channel_descr_done_write
always @(posedge ACLK) begin
    if (ARESET)
        int_channel_descr_done_write <= 1'b0;
    else if (ACLK_EN) begin
        if (aw_hs && AWADDR[ADDR_BITS-1:0] >= ADDR_CHANNEL_DESCR_DONE_BASE && AWADDR[ADDR_BITS-1:0] <= ADDR_CHANNEL_DESCR_DONE_HIGH)
            int_channel_descr_done_write <= 1'b1;
        else if (w_hs)
            int_channel_descr_done_write <= 1'b0;
    end
end

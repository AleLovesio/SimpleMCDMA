...
#
# Generated by export_simulation on Tue May 02 02:09:44 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './tb_sim.sh' script.
...
./tb_sim.sh -noclean_files

For more information on the script, please type './tb_sim.sh -help'.

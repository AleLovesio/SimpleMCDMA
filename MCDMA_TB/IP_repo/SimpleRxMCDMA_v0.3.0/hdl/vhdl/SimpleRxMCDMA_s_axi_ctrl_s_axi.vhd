...
architecture behave of SimpleRxMCDMA_s_axi_ctrl_s_axi is
    ...
    signal int_channel_descr_transfered_data_q0 : UNSIGNED(31 downto 0);
    ...
    signal int_channel_descr_transfered_data_we1 : STD_LOGIC;
    signal int_channel_descr_transfered_data_be1 : UNSIGNED(3 downto 0);
    signal int_channel_descr_transfered_data_d1 : UNSIGNED(31 downto 0);
...
-- ----------------------- Memory logic ------------------
    ...
    channel_descr_transfered_data_q0 <= STD_LOGIC_VECTOR(RESIZE(int_channel_descr_transfered_data_q0, 32));
    ...
    int_channel_descr_transfered_data_we1 <= '1' when int_channel_descr_transfered_data_write = '1' and w_hs = '1' else '0';
    int_channel_descr_transfered_data_be1 <= UNSIGNED(WSTRB) when int_channel_descr_transfered_data_we1 = '1' else (others=>'0');
    int_channel_descr_transfered_data_d1 <= UNSIGNED(WDATA);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_channel_descr_transfered_data_write <= '0';
            elsif (ACLK_EN = '1') then
                if (aw_hs = '1' and UNSIGNED(AWADDR(ADDR_BITS-1 downto 0)) >= ADDR_CHANNEL_DESCR_TRANSFERED_DATA_BASE and UNSIGNED(AWADDR(ADDR_BITS-1 downto 0)) <= ADDR_CHANNEL_DESCR_TRANSFERED_DATA_HIGH) then
                    int_channel_descr_transfered_data_write <= '1';
                elsif (w_hs = '1') then
                    int_channel_descr_transfered_data_write <= '0';
                end if;
            end if;

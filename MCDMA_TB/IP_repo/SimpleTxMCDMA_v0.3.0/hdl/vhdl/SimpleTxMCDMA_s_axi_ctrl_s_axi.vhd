...
entity SimpleTxMCDMA_s_axi_ctrl_s_axi is
generic (
...
end entity SimpleTxMCDMA_s_axi_ctrl_s_axi;
...
architecture behave of SimpleTxMCDMA_s_axi_ctrl_s_axi is
    ...
    component SimpleTxMCDMA_s_axi_ctrl_s_axi_ram is
        generic (
    ...
    end component SimpleTxMCDMA_s_axi_ctrl_s_axi_ram;
...
int_channel_descr_addr : SimpleTxMCDMA_s_axi_ctrl_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
int_channel_descr_len : SimpleTxMCDMA_s_axi_ctrl_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
int_channel_descr_enable : SimpleTxMCDMA_s_axi_ctrl_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_channel_descr_addr_read = '0') and (int_channel_descr_len_read = '0') and (int_channel_descr_enable_read = '0') else '0';
    RVALID    <= RVALID_t;
...
entity SimpleTxMCDMA_s_axi_ctrl_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity SimpleTxMCDMA_s_axi_ctrl_s_axi_ram;

architecture behave of SimpleTxMCDMA_s_axi_ctrl_s_axi_ram is

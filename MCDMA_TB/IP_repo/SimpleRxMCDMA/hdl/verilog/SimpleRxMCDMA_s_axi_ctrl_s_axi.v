...
// ==============================================================
`timescale 1ns/1ps
module SimpleRxMCDMA_s_axi_ctrl_s_axi
#(parameter
    ...
    input  wire [1:0]                    channel_descr_done_address0,
    input  wire                          channel_descr_done_ce0,
    input  wire                          channel_descr_done_we0,
    input  wire [0:0]                    channel_descr_done_d0,
    input  wire [1:0]                    channel_descr_error_address0,
    input  wire                          channel_descr_error_ce0,
    input  wire                          channel_descr_error_we0,
    input  wire [0:0]                    channel_descr_error_d0,
    input  wire [1:0]                    channel_descr_transfered_data_address0,
    input  wire                          channel_descr_transfered_data_ce0,
    input  wire                          channel_descr_transfered_data_we0,
    input  wire [31:0]                   channel_descr_transfered_data_d0,
    output wire [31:0]                   channel_descr_transfered_data_q0,
...
localparam
    ...
    ADDR_IER                                = 7'h08,
    ADDR_ISR                                = 7'h0c,
    ADDR_CHANNEL_DESCR_ADDR_BASE            = 7'h10,
    ADDR_CHANNEL_DESCR_ADDR_HIGH            = 7'h1f,
    ADDR_CHANNEL_DESCR_LEN_BASE             = 7'h20,
    ADDR_CHANNEL_DESCR_LEN_HIGH             = 7'h2f,
    ADDR_CHANNEL_DESCR_ENABLE_BASE          = 7'h30,
    ADDR_CHANNEL_DESCR_ENABLE_HIGH          = 7'h37,
    ADDR_CHANNEL_DESCR_DONE_BASE            = 7'h38,
    ADDR_CHANNEL_DESCR_DONE_HIGH            = 7'h3f,
    ADDR_CHANNEL_DESCR_ERROR_BASE           = 7'h40,
    ADDR_CHANNEL_DESCR_ERROR_HIGH           = 7'h47,
    ADDR_CHANNEL_DESCR_TRANSFERED_DATA_BASE = 7'h50,
    ADDR_CHANNEL_DESCR_TRANSFERED_DATA_HIGH = 7'h5f,
    WRIDLE                                  = 2'd0,
    WRDATA                                  = 2'd1,
    WRRESP                                  = 2'd2,
    WRRESET                                 = 2'd3,
...
//------------------------Local signal-------------------
    ...
    wire [0:0]                    int_channel_descr_done_address0;
    wire                          int_channel_descr_done_ce0;
    wire [3:0]                    int_channel_descr_done_be0;
    wire [31:0]                   int_channel_descr_done_d0;
    wire [0:0]                    int_channel_descr_done_address1;
    wire                          int_channel_descr_done_ce1;
    wire [31:0]                   int_channel_descr_done_q1;
    reg                           int_channel_descr_done_read;
    reg                           int_channel_descr_done_write;
    reg  [1:0]                    int_channel_descr_done_shift0;
    wire [0:0]                    int_channel_descr_error_address0;
    wire                          int_channel_descr_error_ce0;
    wire [3:0]                    int_channel_descr_error_be0;
    wire [31:0]                   int_channel_descr_error_d0;
    wire [0:0]                    int_channel_descr_error_address1;
    wire                          int_channel_descr_error_ce1;
    wire [31:0]                   int_channel_descr_error_q1;
    reg                           int_channel_descr_error_read;
    reg                           int_channel_descr_error_write;
    reg  [1:0]                    int_channel_descr_error_shift0;
    wire [1:0]                    int_channel_descr_transfered_data_address0;
    wire                          int_channel_descr_transfered_data_ce0;
    wire [3:0]                    int_channel_descr_transfered_data_be0;
    wire [31:0]                   int_channel_descr_transfered_data_d0;
    wire [31:0]                   int_channel_descr_transfered_data_q0;
    wire [1:0]                    int_channel_descr_transfered_data_address1;
    wire                          int_channel_descr_transfered_data_ce1;
    wire                          int_channel_descr_transfered_data_we1;
    wire [3:0]                    int_channel_descr_transfered_data_be1;
    wire [31:0]                   int_channel_descr_transfered_data_d1;
    wire [31:0]                   int_channel_descr_transfered_data_q1;
    reg                           int_channel_descr_transfered_data_read;
    reg                           int_channel_descr_transfered_data_write;

//------------------------Instantiation------------------
// int_channel_descr_addr
SimpleRxMCDMA_s_axi_ctrl_s_axi_ram #(
    .MEM_STYLE ( "auto" ),
    .MEM_TYPE  ( "2P" ),
    .BYTES     ( 4 ),
    .DEPTH     ( 4 )
...
SimpleRxMCDMA_s_axi_ctrl_s_axi_ram #(
    ...
    .q0        ( int_channel_descr_transfered_data_q0 ),
    .clk1      ( ACLK ),
    .address1  ( int_channel_descr_transfered_data_address1 ),
    .ce1       ( int_channel_descr_transfered_data_ce1 ),
    .we1       ( int_channel_descr_transfered_data_be1 ),
    .d1        ( int_channel_descr_transfered_data_d1 ),
...
assign RVALID  = (rstate == RDDATA) & !int_channel_descr_addr_read & !int_channel_descr_len_read & !int_channel_descr_enable_read & !int_channel_descr_done_read & !int_channel_descr_error_read & !int_channel_descr_transfered_data_read;
...
always @(posedge ACLK) begin
    if (ACLK_EN) begin
        ...
        else if (int_channel_descr_done_read) begin
            rdata <= int_channel_descr_done_q1;
        end
        else if (int_channel_descr_error_read) begin
            rdata <= int_channel_descr_error_q1;
        end
        else if (int_channel_descr_transfered_data_read) begin
            rdata <= int_channel_descr_transfered_data_q1;
        end
    end
end
...
// channel_descr_done
assign int_channel_descr_done_address0            = channel_descr_done_address0 >> 2;
assign int_channel_descr_done_ce0                 = channel_descr_done_ce0;
assign int_channel_descr_done_be0                 = channel_descr_done_we0 << channel_descr_done_address0[1:0];
assign int_channel_descr_done_d0                  = {4{7'd0, channel_descr_done_d0}};
assign int_channel_descr_done_address1            = ar_hs? raddr[2:2] : waddr[2:2];
assign int_channel_descr_done_ce1                 = ar_hs | (int_channel_descr_done_write & WVALID);
// channel_descr_error
assign int_channel_descr_error_address0           = channel_descr_error_address0 >> 2;
assign int_channel_descr_error_ce0                = channel_descr_error_ce0;
assign int_channel_descr_error_be0                = channel_descr_error_we0 << channel_descr_error_address0[1:0];
assign int_channel_descr_error_d0                 = {4{7'd0, channel_descr_error_d0}};
assign int_channel_descr_error_address1           = ar_hs? raddr[2:2] : waddr[2:2];
assign int_channel_descr_error_ce1                = ar_hs | (int_channel_descr_error_write & WVALID);
// channel_descr_transfered_data
assign int_channel_descr_transfered_data_address0 = channel_descr_transfered_data_address0;
assign int_channel_descr_transfered_data_ce0      = channel_descr_transfered_data_ce0;
assign int_channel_descr_transfered_data_be0      = {4{channel_descr_transfered_data_we0}};
assign int_channel_descr_transfered_data_d0       = channel_descr_transfered_data_d0;
assign channel_descr_transfered_data_q0           = int_channel_descr_transfered_data_q0;
assign int_channel_descr_transfered_data_address1 = ar_hs? raddr[3:2] : waddr[3:2];
assign int_channel_descr_transfered_data_ce1      = ar_hs | (int_channel_descr_transfered_data_write & WVALID);
assign int_channel_descr_transfered_data_we1      = int_channel_descr_transfered_data_write & w_hs;
assign int_channel_descr_transfered_data_be1      = int_channel_descr_transfered_data_we1 ? WSTRB : 'b0;
assign int_channel_descr_transfered_data_d1       = WDATA;
...
always @(posedge ACLK) begin
    if (ARESET)
        int_channel_descr_done_read <= 1'b0;
    else if (ACLK_EN) begin
        if (ar_hs && raddr >= ADDR_CHANNEL_DESCR_DONE_BASE && raddr <= ADDR_CHANNEL_DESCR_DONE_HIGH)
            int_channel_descr_done_read <= 1'b1;
        else
            int_channel_descr_done_read <= 1'b0;
    end
end

// int_channel_descr_done_shift0
always @(posedge ACLK) begin
    if (ARESET)
        int_channel_descr_done_shift0 <= 1'b0;
    else if (ACLK_EN) begin
        if (channel_descr_done_ce0)
            int_channel_descr_done_shift0 <= channel_descr_done_address0[1:0];
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_channel_descr_error_read <= 1'b0;
    else if (ACLK_EN) begin
        if (ar_hs && raddr >= ADDR_CHANNEL_DESCR_ERROR_BASE && raddr <= ADDR_CHANNEL_DESCR_ERROR_HIGH)
            int_channel_descr_error_read <= 1'b1;
        else
            int_channel_descr_error_read <= 1'b0;
    end
end

// int_channel_descr_error_shift0
always @(posedge ACLK) begin
    if (ARESET)
        int_channel_descr_error_shift0 <= 1'b0;
    else if (ACLK_EN) begin
        if (channel_descr_error_ce0)
            int_channel_descr_error_shift0 <= channel_descr_error_address0[1:0];
    end
end

// int_channel_descr_transfered_data_read
always @(posedge ACLK) begin
    if (ARESET)
        int_channel_descr_transfered_data_read <= 1'b0;
    else if (ACLK_EN) begin
        if (ar_hs && raddr >= ADDR_CHANNEL_DESCR_TRANSFERED_DATA_BASE && raddr <= ADDR_CHANNEL_DESCR_TRANSFERED_DATA_HIGH)
            int_channel_descr_transfered_data_read <= 1'b1;
        else
            int_channel_descr_transfered_data_read <= 1'b0;
    end
end

// int_channel_descr_transfered_data_write
always @(posedge ACLK) begin
    if (ARESET)
        int_channel_descr_transfered_data_write <= 1'b0;
    else if (ACLK_EN) begin
        if (aw_hs && AWADDR[ADDR_BITS-1:0] >= ADDR_CHANNEL_DESCR_TRANSFERED_DATA_BASE && AWADDR[ADDR_BITS-1:0] <= ADDR_CHANNEL_DESCR_TRANSFERED_DATA_HIGH)
            int_channel_descr_transfered_data_write <= 1'b1;
        else if (w_hs)
            int_channel_descr_transfered_data_write <= 1'b0;
    end
end
...
module SimpleRxMCDMA_s_axi_ctrl_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,

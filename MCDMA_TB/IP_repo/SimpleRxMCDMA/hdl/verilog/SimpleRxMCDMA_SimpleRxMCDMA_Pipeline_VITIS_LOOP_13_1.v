...
reg   [7:0] n_remaining_channels_fu_58;
wire   [7:0] n_remaining_channels_3_fu_175_p3;
wire    ap_loop_init;
reg   [2:0] i_fu_62;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln13_fu_141_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            n_remaining_channels_fu_58 <= 8'd0;
...
always @ (*) begin
    if (((icmp_ln13_fu_141_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln13_fu_141_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln13_fu_141_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln13_fu_147_p2 = (ap_sig_allocacmp_i_1 + 3'd1);

assign add_ln17_fu_169_p2 = (n_remaining_channels_fu_58 + 8'd1);
...
assign channel_descr_done_address0 = i_cast_fu_153_p1;

assign channel_descr_done_d0 = 1'd0;

assign channel_descr_enable_address0 = i_cast_fu_153_p1;

assign channel_descr_error_address0 = i_cast_fu_153_p1;

assign channel_descr_error_d0 = 1'd0;

assign channel_descr_transfered_data_address0 = i_cast_fu_153_p1;

assign channel_descr_transfered_data_d0 = 32'd0;

assign i_cast_fu_153_p1 = ap_sig_allocacmp_i_1;

assign icmp_ln13_fu_141_p2 = ((ap_sig_allocacmp_i_1 == 3'd4) ? 1'b1 : 1'b0);

assign n_remaining_channels_3_fu_175_p3 = ((channel_descr_enable_q0[0:0] == 1'b1) ? add_ln17_fu_169_p2 : n_remaining_channels_fu_58);

assign n_remaining_channels_out = n_remaining_channels_fu_58;

...
module SimpleRxMCDMA_SimpleRxMCDMA_Pipeline_VITIS_LOOP_13_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        n_remaining_channels_out_ap_vld
);
...
output   n_remaining_channels_out_ap_vld;
...
reg n_remaining_channels_out_ap_vld;
...
wire   [31:0] zext_ln15_fu_155_p1;
wire    ap_block_pp0_stage0;
reg   [7:0] n_remaining_channels_fu_56;
wire   [7:0] n_remaining_channels_3_fu_177_p3;
wire    ap_loop_init;
reg   [2:0] i_fu_60;
wire   [2:0] add_ln13_fu_145_p2;
reg   [2:0] ap_sig_allocacmp_i_1;
wire    ap_block_pp0_stage0_01001;
wire   [1:0] trunc_ln15_fu_151_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln13_fu_139_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            n_remaining_channels_fu_56 <= 8'd0;
...
always @ (*) begin
    if (((icmp_ln13_fu_139_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln13_fu_139_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln13_fu_139_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        n_remaining_channels_out_ap_vld = 1'b1;
    end else begin
        n_remaining_channels_out_ap_vld = 1'b0;
    end
end
...
assign add_ln13_fu_145_p2 = (ap_sig_allocacmp_i_1 + 3'd1);

assign add_ln17_fu_171_p2 = (n_remaining_channels_fu_56 + 8'd1);
...
assign channel_descr_done_address0 = zext_ln15_fu_155_p1;

assign channel_descr_done_d0 = 1'd0;

assign channel_descr_enable_address0 = zext_ln15_fu_155_p1;

assign channel_descr_error_address0 = zext_ln15_fu_155_p1;

assign channel_descr_error_d0 = 1'd0;

assign channel_descr_transfered_data_address0 = zext_ln15_fu_155_p1;

assign channel_descr_transfered_data_d0 = 32'd0;

assign icmp_ln13_fu_139_p2 = ((ap_sig_allocacmp_i_1 == 3'd4) ? 1'b1 : 1'b0);

assign n_remaining_channels_3_fu_177_p3 = ((channel_descr_enable_q0[0:0] == 1'b1) ? add_ln17_fu_171_p2 : n_remaining_channels_fu_56);

assign n_remaining_channels_out = n_remaining_channels_fu_56;

assign trunc_ln15_fu_151_p1 = ap_sig_allocacmp_i_1[1:0];

assign zext_ln15_fu_155_p1 = trunc_ln15_fu_151_p1;

endmodule //SimpleRxMCDMA_SimpleRxMCDMA_Pipeline_VITIS_LOOP_13_1
